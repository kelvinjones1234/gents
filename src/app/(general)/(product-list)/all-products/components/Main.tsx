...
export default function Main({ initialProducts }: MainProps) {
  ...
  const ITEMS_PER_PAGE = 12; // Increased for the "All Products" view
  ...
  return (
    <div className="bg-white min-h-screen flex flex-col">
      ...
      <header className="pt-24 pb-16 bg-white text-foreground border-b border-gray-100">
        <div className="container-main mx-auto px-6 text-center">
          <div className="flex items-center justify-center gap-2 text-muted mb-4">
            ...
            <span className="text-[9px] font-bold uppercase tracking-[0.3em]">Full Catalogue</span>
          </div>
