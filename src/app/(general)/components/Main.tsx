...
//       // 1. Open Modal for Variant Selection
//       setSelectedProductForModal(product);
//       setIsOptionModalOpen(true);
//     } else {
//       // 2. Simple Product: Add directly to cart (Connect your Cart Context here)
...
//     quantity?: number
//   ) => {
//     // 3. Variant Product: Add specific variant to cart (Connect your Cart Context here)
//     console.log(
//       `Adding Variant ${variantId} of ${product.name} (Qty: ${quantity})`
//     );
//     alert(`Added ${product.name} (Variant selected) to cart!`);
//   };
...
//   // Reduces repetition for New Arrivals, Hot Deals, Top Sellers, etc.
//   const ProductCard = ({
//     item,
//     badgeLabel,
...
//     badgeColor?: string;
//   }) => {
//     // Calculate total stock across all variants if they exist, or use base stock
//     const totalStock =
//       item.hasVariants && item.variants
//         ? item.variants.reduce((sum, v) => sum + v.stock, 0)
//         : item.stock;
