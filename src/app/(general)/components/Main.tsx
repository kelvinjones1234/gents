...
// import { getProductsByCategory } from "@/app/actions/storefront"; // Import the action
...
//   newArrivals,
//   hotDeals,
//   featuredProducts, // Initial "All" data
//   topSellers,
//   featuredCategories,
//   allCategories,
// }: MainProps) {
...
//   // --- 1. DYNAMIC TABS LOGIC ---
//   const tabs = useMemo(() => {
//     // Manually add "All" to the start of the list
...
//       // If clicking "All", we could use the initial prop to save a fetch,
//       // but fetching ensures stock is fresh.
//       const products = await getProductsByCategory(tabId);
//       // @ts-ignore - Prisma return types can be tricky with partial selects, casting for safety
...
//             2026
//           </h1>
//           <div className="absolute bottom-12 right-6 md:right-12 text-right text-white text-[10px] md:text-xs tracking-widest uppercase font-medium space-y-1">
...
//         <div className="container-main mx-auto px-6 md:px-12 flex flex-col md:flex-row items-center justify-center gap-16 md:gap-8 lg:gap-12">
//           <div className="w-full md:w-[40%] flex flex-col items-center md:items-end justify-center gap-6 md:gap-10 order-1 z-10">
//             {leftCategories.map((cat, i) => (
//               <a
//                 key={cat.id}
//                 href={`/collections/${cat.slug}`}
//                 className={`group flex items-start ${i === 1 ? "md:mr-10 lg:mr-16" : ""}`}
//               >
//                 <span
//                   className={`font-display text-4xl sm:text-5xl md:text-3xl lg:text-4xl xl:text-[60px] font-medium border-b-[2px] border-transparent pb-1 tracking-tight transition-all duration-300 ${i === 0 ? "text-foreground md:text-[#222222] md:border-[#222222]" : "text-transparent [-webkit-text-stroke:1px_#A3A3A3] md:text-[#CECECE] md:[-webkit-text-stroke:0] group-hover:text-foreground md:group-hover:text-[#222222] group-hover:[-webkit-text-stroke:0] md:group-hover:border-[#222222]"}`}
//                 >
//                   {i === 0 && (
//                     <span className="font-light mr-2 md:mr-3 text-muted md:text-[#222222]">
//                       /
//                     </span>
//                   )}
...
//                 </span>
//                 <sup
//                   className={`text-[10px] sm:text-xs font-medium ml-1 mt-2 md:mt-3 transition-colors duration-300 ${i === 0 ? "text-muted md:text-[#222222]" : "text-[#A3A3A3] md:text-[#CECECE] group-hover:text-foreground md:group-hover:text-[#222222]"}`}
//                 >
//                   {cat._count.products}
//                 </sup>
//               </a>
...
//           <div className="w-full md:w-[40%] flex flex-col items-center md:items-start justify-center gap-6 md:gap-10 order-3 z-10 md:mt-8">
//             {rightCategories.map((cat, i) => (
//               <a
//                 key={cat.id}
//                 href={`/collections/${cat.slug}`}
//                 className={`group flex items-start ${i === 1 ? "md:ml-10 lg:ml-16" : ""}`}
//               >
//                 <span className="font-display text-4xl sm:text-5xl md:text-3xl lg:text-4xl xl:text-[60px] font-medium pb-1 tracking-tight border-b-[2px] border-transparent md:border-[#CECECE] text-transparent [-webkit-text-stroke:1px_#A3A3A3] md:text-[#CECECE] md:[-webkit-text-stroke:0] group-hover:text-foreground md:group-hover:text-[#222222] group-hover:[-webkit-text-stroke:0] md:group-hover:border-[#222222] transition-all duration-300">
//                   {cat.name.toUpperCase()}
//                 </span>
//                 <sup className="text-[10px] sm:text-xs font-medium ml-1 mt-2 md:mt-3 text-[#A3A3A3] md:text-[#CECECE] group-hover:text-foreground md:group-hover:text-[#222222] transition-colors duration-300">
//                   {cat._count.products}
//                 </sup>
//               </a>
//             ))}
...
//             <div
//               key={item.id}
//               className="min-w-[280px] md:min-w-[340px] w-full max-w-[340px] snap-start group cursor-pointer flex flex-col"
//             >
...
//                   <button className="w-full py-4 text-[10px] font-bold uppercase tracking-widest text-white hover:bg-black transition-colors">
//                     Quick Add
//                   </button>
//                 </div>
//               </div>
...
//                   {item.categories?.[0]?.name || "Gents & Co."}
//                 </p>
//                 <p className="text-[11px] font-bold tracking-wide tabular-nums text-foreground mt-1">
...
//         <div className="container-main mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-24 items-center">
...
//               Tech Spotlight
//             </h2>
//             <h3 className="font-display text-6xl md:text-7xl lg:text-8xl font-medium leading-[0.9] tracking-tight text-foreground">
//               SOUND
//               <br />
//               WITHOUT
//               <br />
...
//               industrial design.
//             </p>
//             <div className="mt-8 flex items-center gap-3 text-foreground text-xs font-bold uppercase tracking-widest cursor-pointer group self-start">
...
//             <div className="absolute inset-0 bg-gray-100 mix-blend-multiply transition-colors duration-500 hover:bg-transparent z-10 pointer-events-none"></div>
//             <img
//               src="https://images.unsplash.com/photo-1584445584442-45e45a7df418?auto=format&fit=crop&q=80&w=800"
//               alt="EDC"
//               className="w-full h-full object-cover hover:scale-105 transition-all duration-1000"
//             />
//           </div>
...
//                     ₦{(item.discountPrice || item.basePrice).toLocaleString()}
//                   </p>
//                 </div>
//               </div>
//             </div>
...
//               Campaign
//             </h2>
//             <h3 className="font-display text-6xl md:text-7xl lg:text-8xl font-medium leading-[0.9] tracking-tight">
//               THE
//               <br />
//               STEALTH
//               <br />
...
//             <img
//               src="https://images.unsplash.com/photo-1547949007-5629c14bc5ee?auto=format&fit=crop&q=80&w=800"
//               alt="Stealth Series"
...
//       {/* 10. FEATURED COLLECTIONS (Tabs) */}
//       <section className="py-16 bg-white border-b border-gray-200 min-h-[500px]">
//         <div className="container-main mx-auto px-6 md:px-12">
//           <div className="flex flex-col items-center mb-16">
//             <h2 className="font-display text-3xl md:text-4xl lg:text-5xl font-medium tracking-tight uppercase mb-10 text-foreground text-center">
...
//                   disabled={isPending}
//                   className={`text-[10px] md:text-xs font-bold uppercase tracking-widest pb-2 border-b-2 transition-all duration-300 ${
//                     activeTab === tab.id
...
//         {/* PRODUCT GRID WITH LOADER STATE */}
...
//             <p className="text-2xl md:text-4xl lg:text-5xl font-display font-medium leading-[1.2] text-muted uppercase tracking-tight">
...
//       <section className="py-16 bg-[#FAFAFA] border-b border-gray-200">
//         <div className="container-main mx-auto px-6 md:px-12">
//           <h2 className="text-xs font-bold uppercase tracking-widest mb-16 md:mb-24 text-foreground">
//             Collaborations
//           </h2>
...
//         <div className="container-main mx-auto px-6 md:px-12 flex flex-col md:flex-row justify-between items-start md:items-center mb-10 gap-4">
...
//             <div
//               key={i}
//               className="min-w-[240px] md:min-w-[300px] aspect-square flex-shrink-0 group relative cursor-pointer overflow-hidden bg-gray-100"
//             >
//               <img
    ...
    <div className="bg-background text-foreground font-sans antialiased transition-colors duration-300">
      ...
      <section className="relative w-full h-[75vh] md:h-[90vh] bg-gradient-to-tr from-[#5E7472] via-[#87928E] to-[#C2B3A1] overflow-hidden flex items-center">
        ...
        <div className="container-main mx-auto relative z-10 w-full flex flex-col justify-center h-full px-6 md:px-12">
          ...
          {/* Category list: hidden on very small screens, shown from sm up */}
        ...
        <div className="container-main mx-auto px-6 md:px-12 flex flex-col md:flex-row items-center justify-center gap-8 md:gap-8 lg:gap-12">
          ...
          <div className="w-full md:w-[40%] flex flex-col items-center md:items-end justify-center gap-4 md:gap-10 order-1 z-10">
            {leftCategories.map((cat, i) => (
              ...
              >
                <span
                  className={`font-display text-3xl sm:text-4xl md:text-3xl lg:text-4xl xl:text-[60px] font-medium border-b-[2px] border-transparent pb-1 tracking-tight transition-all duration-300 ${i === 0 ? "text-foreground md:text-[#222222] md:border-[#222222]" : "text-transparent [-webkit-text-stroke:1px_#A3A3A3] md:text-[#CECECE] md:[-webkit-text-stroke:0] group-hover:text-foreground md:group-hover:text-[#222222] group-hover:[-webkit-text-stroke:0] md:group-hover:border-[#222222]"}`}
                >
                  {/* {i === 0 && (
                    <span className="font-light mr-2 md:mr-3 text-muted md:text-[#222222]">
                      /
          ...
          <div className="w-full md:w-[40%] flex flex-col items-center md:items-start justify-center gap-4 md:gap-10 order-2 md:order-3 z-10 md:mt-8">
            {rightCategories.map((cat, i) => (
              <a
                ...
                className={`group flex items-start ${i === 1 ? "md:ml-10 lg:ml-16" : ""}`}
              >
                <span className="font-display text-3xl sm:text-4xl md:text-3xl lg:text-4xl xl:text-[60px] font-medium pb-1 tracking-tight border-b-[2px] border-transparent md:border-[#CECECE] text-transparent [-webkit-text-stroke:1px_#A3A3A3] md:text-[#CECECE] md:[-webkit-text-stroke:0] group-hover:text-foreground md:group-hover:text-[#222222] group-hover:[-webkit-text-stroke:0] md:group-hover:border-[#222222] transition-all duration-300">
                  {cat.name.toUpperCase()}
                </span>
                <sup className="text-[10px] sm:text-xs font-medium ml-1 mt-2 md:mt-3 text-[#A3A3A3] md:text-[#CECECE] group-hover:text-foreground md:group-hover:text-[#222222] transition-colors duration-300">
                  {cat._count.products}
      ...
      <section className="py-16 bg-[#FAFAFA] border-b border-gray-200">
        ...
        {/* Scrollable row on mobile; auto-fit grid on larger screens */}
        <div className="flex overflow-x-auto gap-4 md:gap-6 hide-scrollbar pb-12 snap-x px-6 md:px-12">
          {newArrivals.map((item) => (
            <div
              key={item.id}
              className="min-w-[240px] sm:min-w-[280px] md:min-w-[340px] w-full max-w-[340px] snap-start group cursor-pointer flex flex-col"
            >
              <div className="aspect-[4/5] w-full bg-[#EFEFEF] relative overflow-hidden transition-colors duration-500 hover:bg-[#E5E5E5] border border-gray-100">
                <div className="absolute top-4 left-4 z-20">
                  <span className="bg-foreground px-3 py-1.5 text-[9px] font-bold uppercase tracking-widest text-white rounded-full shadow-sm">
                ...
                {/* Quick Add: always visible tap target on touch, hover on desktop */}
                <div className="absolute bottom-0 left-0 right-0 bg-foreground/95 backdrop-blur-sm translate-y-full group-hover:translate-y-0 transition-transform duration-500 ease-out z-20">
                  <button className="w-full py-4 text-[10px] font-bold uppercase tracking-widest text-white hover:bg-black transition-colors">
                    Quick Add
                  </button>
      ...
      <section className="py-16 bg-white border-b border-gray-200 min-h-[500px]">
        <div className="container-main mx-auto px-6 md:px-12">
          <div className="flex flex-col items-center mb-16">
            ...
            {/* Tabs: horizontal scroll on mobile so they don't wrap awkwardly */}
